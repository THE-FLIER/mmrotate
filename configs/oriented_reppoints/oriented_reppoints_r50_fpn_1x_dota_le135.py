_base_ = [
    '../_base_/datasets/dotav1.py', '../_base_/schedules/schedule_40e.py',
...
model = dict(
    ...
    backbone=dict(
        ...
        norm_eval=True,
        style='pytorch',
        init_cfg=dict(type='Pretrained', checkpoint='configs/oriented_reppoints/oriented_reppoints_r50_fpn_40e_dota_ms_le135-bb0323fd.pth')),
    neck=dict(
        type='FPN',
